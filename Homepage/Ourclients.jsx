...
import styles from './OurClients.module.css'; // Use CSS Module for scoped styles
...
const OurClients = () => {
  return (
    <Container fluid className={styles.ourClientsSection + ' text-center'}>
      ...
      <div className={styles.marqueeContainer}>
        ...
        <div className={styles.marquee + ' ' + styles.marquee2 + ' ' + styles.reverse}>
          <div className={styles.marqueeContent}>
            {clients.concat(clients).map((client, index) => (
              <div key={index + clients.length} className={styles.clientLogoContainer}>
                <Image
                  src={client.logo}
                  alt={client.name}
                  className={styles.clientLogo}
